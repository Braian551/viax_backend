...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Configuración de precios para servicio de moto';

-- Insertar configuración por defecto para MOTO
...
-- 3. Confirmar que hay 1 registro activo en configuracion_precios
