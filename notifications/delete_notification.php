 ...
 * Elimina (soft delete) una o varias notificaciones
 * 
 * POST Body (JSON):
 ...
 * - delete_all: Eliminar todas (opcional)
 */
...
try {
    ...
    $delete_all = isset($input['delete_all']) && $input['delete_all'] === true;
    ...
    if ($delete_all) {
        ...
        $query = "
            ...
            SET eliminada = TRUE, eliminada_en = CURRENT_TIMESTAMP
        ...
        echo json_encode([
            'success' => false,
            'error' => 'Debe especificar notification_id, notification_ids, o delete_all'
        ]);
        exit;
    }
    ...
    echo json_encode([
        'success' => true,
        'message' => "Se eliminaron $affected notificaciones",
        'affected' => $affected,
